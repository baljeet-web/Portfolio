import {
  ...
  */
  export const githubUsername = "baljeet-web";
  ...
  */
  ...
  export const resume = "https://drive.google.com/file/d/1FmSApURsLknihjThBHOiX4xKPZ19rSKE/view?usp=sharing";
  
  /* Projects
   ************************************************************** 
    List the repo names (string - "your-repo-name") you want to include (they will be sorted alphabetically). If empty, only the first 3 will be included.
  */
  export const filteredProjects = ["Responsive-website", "sendtextutils", "iNotebook"];
